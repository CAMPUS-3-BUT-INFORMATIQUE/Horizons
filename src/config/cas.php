...
return [
    ...
    */
    'cas_hostname' => env('CAS_HOSTNAME', 'cas.unicaen.fr'),
    ...
    */
    'cas_real_hosts' => env('CAS_REAL_HOSTS', 'cas.unicaen.fr'),
    ...
    */
    'cas_client_service' => env('CAS_CLIENT_SERVICE', 'https://dev-toitot211.users.info.unicaen.fr/'),
    ...
    */
    ...
    | Empty is fine
    */
    'cas_login_url' => env('CAS_LOGIN_URL', 'https://cas.unicaen.fr/login'),
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'https://cas.unicaen.fr/logout'),
